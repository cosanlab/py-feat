...
df = read_facet('/Users/haines.175/Dropbox/Box/GitHub/feat/feat/tests/data/iMotions_Test.txt')
...
newdat['sessions'].nunique()==52
len(extractor.merge(out_format='long'))==24960
len(extractor.merge(out_format='wide'))==52
isinstance(newdat, DataFrame)
extractor.is_merged
extractor.extracted_features.melt(id_vars='session')

type(extractor.extracted_features)
