...
# https://github.com/timesler/facenet-pytorch/blob/dd0b0e4b5b124b599f75b87e570910e5d80c8848/models/mtcnn.py#L157
...
# test case:
from PIL import Image
im01 = Image.open("F:/test_case/0000.jpg")
k01 = MTCNN()
rectangles = k01.detect(im01)
# %%
import cv2
x,y,w,h = rectangles[0][0]
im02 = cv2.imread("F:/test_case/0000.jpg")
cv2.rectangle(im02,(int(x),int(y)),(int(x+w),int(y+h)),(0,255,0),2)
cv2.putText(im02,'Moth Detected',(int(x+w+10),int(y+h)),0,0.3,(0,255,0))
cv2.imshow("Show",im02)
cv2.waitKey()  
