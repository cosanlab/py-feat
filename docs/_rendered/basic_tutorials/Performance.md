...
<pre class="marimo-book-output-text marimo-stream-stdout">single-image detect: 0.038s on mps
</pre>
...
<pre class="marimo-book-output-text marimo-stream-stdout">8 images, batch_size=8: 0.271s
</pre>
