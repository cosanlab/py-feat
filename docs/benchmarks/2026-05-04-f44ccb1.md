...
If a user has MPS available, they shouldn't be running on CPU. The `Detectorv1(device='auto')` default should handle this correctly, but worth flagging in the docs.
